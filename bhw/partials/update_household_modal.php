...
<div class="modal fade" id="editHouseholdModal<?php echo htmlspecialchars($household['household_id']); ?>" tabindex="-1" aria-labelledby="editHouseholdModalLabel<?php echo htmlspecialchars($household['household_id']); ?>" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="../controllers/bhw_update_household.php" method="POST">
                <div class="modal-header">
                    <h5 class="modal-title" id="editHouseholdModalLabel<?php echo htmlspecialchars($household['household_id']); ?>">Edit Household</h5>
