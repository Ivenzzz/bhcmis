...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 30, 2025 at 09:55 PM
...
(2, 'BHW1', '$2y$10$Fp06K.3nimzVrtsC.VQMs.mkYrm0vpq5rYhDvktMiIY7SZbWbkozW', 'bhw', '/bhcmis/storage/uploads/67984993cc1d3.png', 0, 0, 1, '2025-01-27 03:30:52', '2025-01-28 11:05:55'),
...
(49, 'HC966037477876PH', 163, 22, 1, 'Scheduled', 0, '2025-01-30 18:56:27', '2025-01-30 18:56:27');
...
(14, 66, 14, 11, '2025-01-31', 'active', NULL, 0, '2025-01-31 04:42:59', '2025-01-31 04:42:59');
...
CREATE TABLE `immunizations` (
  ...
  `administed_by` varchar(100) NOT NULL,
...
(1, 12, 2, 'inactive', '2024-03-05', 3, 0, '2024-12-14 11:27:58', '2024-12-14 11:27:58'),
(11, 64, 14, 'active', '2025-01-31', NULL, 0, '2025-01-31 04:01:16', '2025-01-31 04:01:16');
...
(2, 'Singua', 'Reyna Jane', 'Gasparillo', '1994-03-09', 'Married', 'College Graduate', 'Brgy. Midwife', 'Roman Catholic', 'Filipino', 6, 'female', '09851354580', 'reynasorilla@puntamesa.com', NULL, 0, 0, 1, NULL, '2023-07-25 11:07:25', '2025-01-31 03:55:51'),
...
(13, 'Araneta', 'Roy Marjohn', 'Catapang', '2000-04-13', 'Single', 'Highschool Graduate', 'Businessman', 'Iglesia ni Cristo', 'Filipinos', 6, 'male', '09308309599', 'iven.loro@csav.edu.ph', NULL, 0, 1, 1, '2025-01-30', '2024-07-16 11:07:25', '2025-01-30 11:46:20'),
(14, 'Angcona', 'Rovie', 'Singua', '2002-03-04', 'Married', 'College Undergraduate', 'Businesswoman', 'Baptist', 'Filipino', 6, 'female', '09586789012', 'rovieangcona@gmail.com', NULL, 0, 0, 1, NULL, '2024-07-16 11:07:25', '2025-01-31 04:01:51'),
...
(129, 'Catapang', 'Ron', 'Araneta', '2001-04-06', 'Single', 'College Graduate', 'Businessman', 'Roman Catholic', 'Filipino', 6, 'male', NULL, 'catapangron18@gmail.com', '/bhcmis/storage/uploads/id-resident-1738208518.png', 0, 0, 1, NULL, '2025-01-30 11:19:36', '2025-01-30 11:19:36');
...
(5, 4, 1, 'Further Evaluation and Management', 99, 'Midwife Reyna Jane Gasparillo Singua', 'Barangay Punta Mesa Health Center', 'ffffffffffff', 'ffffffffffffffff', 'ffffffffffffffffff', '2025-01-28 00:00:00', '2025-01-30', 'Approved', '../storage/referral_forms/referral_5_20250129_233558.pdf', 22, '2025-01-28 16:55:48', '2025-01-28 16:55:48'),
(6, 4, 0, 'Further Evaluation and Management', NULL, 'Midwife Reyna Jane Gasparillo Singua', 'Barangay Punta Mesa Health Center', 'fffffffffffffff', 'fffffffffffffff', 'fffffffffffffffff', '2025-01-28 00:00:00', NULL, 'Pending', NULL, 22, '2025-01-28 16:58:57', '2025-01-28 16:58:57'),
...
INSERT INTO `vaccines` (`vaccine_id`, `vaccine_name`, `lot_number`, `expiration_date`, `created_at`) VALUES
(16, 'BCG (Tuberculosis)', 'BCG-2026A', '2026-08-31', '2025-01-28 10:47:05'),
(17, 'Pentavalent (DPT-HepB-Hib)', 'PENTA-2026B', '2026-09-30', '2025-01-28 10:47:05'),
(18, 'Oral Polio Vaccine (OPV)', 'OPV-2026C', '2026-10-31', '2025-01-28 10:47:05'),
(19, 'Measles-Mumps-Rubella (MMR)', 'MMR-2026D', '2026-01-31', '2025-01-28 10:47:05'),
(20, 'Tetanus Toxoid (TT)', 'TT-2026E', '2026-12-31', '2025-01-28 10:47:05'),
(21, 'Hepatitis B Birth Dose', 'HEPB-BIRTH-2026F', '2026-07-31', '2025-01-28 10:47:05'),
(22, 'COVID-19 Pfizer-BioNTech', 'PFIZER-2026G', '2026-06-30', '2025-01-28 10:47:05'),
(23, 'Influenza 2026', 'FLU-2026H', '2026-03-31', '2025-01-28 10:47:05'),
(24, 'Pneumococcal Conjugate (PCV13)', 'PCV13-2026I', '2026-02-28', '2025-01-28 10:47:05'),
(25, 'Japanese Encephalitis', 'JE-2026J', '2026-11-30', '2025-01-28 10:47:05'),
(26, 'BCG (Tuberculosis)', 'EXP-BCG-2022', '2023-03-31', '2025-01-28 10:47:05'),
(27, 'Pentavalent (DPT-HepB-Hib)', 'EXP-PENTA-2022A', '2023-05-31', '2025-01-28 10:47:05'),
(28, 'Oral Polio Vaccine (OPV)', 'EXP-OPV-2022B', '2023-02-28', '2025-01-28 10:47:05'),
(29, 'Rotavirus (Rotarix)', 'ROTA-2024K', '2024-04-30', '2025-01-28 10:47:05'),
(30, 'Vitamin A Supplement', 'VITA-2025L', '2025-10-31', '2025-01-28 10:47:05');
...
--
ALTER TABLE `accounts`
  MODIFY `account_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
...
--
ALTER TABLE `appointments`
  MODIFY `appointment_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;

--
-- AUTO_INCREMENT for table `bhw`
--
ALTER TABLE `bhw`
  MODIFY `bhw_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `consultation_schedules`
  MODIFY `con_sched_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `families`
--
ALTER TABLE `families`
  MODIFY `family_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1029;

--
-- AUTO_INCREMENT for table `family_members`
--
ALTER TABLE `family_members`
  MODIFY `fmember_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
...
--
ALTER TABLE `household`
  MODIFY `household_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1025;

--
-- AUTO_INCREMENT for table `household_members`
--
ALTER TABLE `household_members`
  MODIFY `hm_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
...
--
ALTER TABLE `personal_information`
  MODIFY `personal_info_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=130;
...
--
ALTER TABLE `referral_requests`
  MODIFY `referral_id` int(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `residents`
--
ALTER TABLE `residents`
  MODIFY `resident_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=164;
