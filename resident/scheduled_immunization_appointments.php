...
$title = 'Scheduled Immunization Appointments';
...
$appointments = getScheduledImmunizationAppointmentsByResident($conn, $resident_id);
$appointment_schedules = getImmunizationSchedules($conn);
        ...
        <div class="container mt-4 px-5">
            ...
            <div class="row mb-4">
                <div class="col-md-12 d-flex justify-content-center">
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addImmunizationAppointmentModal">Add Appointment</button>
                </div>
            </div>
        </div>
  </div>

    <?php require 'partials/modal_add_immunization_appointment.php'; ?>

    <?php require '../partials/global_javascript_links.php'; ?>
    <script src="../public/js/global_logout.js"></script>
    <script src="../public/js/resident_immunizations.js"></script>
</body>
</html>
