                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-8 d-flex flex-column">
                                ...
                                <?php elseif ($appointment['status'] === 'Completed'): ?>
                                    ...
                                    <a href="consultation_details.php?appointment_id=<?= htmlspecialchars($appointment['appointment_id']); ?>" class="btn btn-sm btn-primary mt-2">View Consultation Result</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
