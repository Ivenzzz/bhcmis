<?php if ($children_appointments && count($children_appointments) > 0): ?>
    <div class="row mb-4 shadow p-4">
        <?php foreach ($children_appointments as $appointment): ?>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-8 d-flex flex-column">
                                ...
                                <h6 class="poppins-light">Name: <?= htmlspecialchars($appointment['firstname']) . ' ' . (isset($appointment['middlename']) ? strtoupper(substr($appointment['middlename'], 0, 1)) . '.' : '') . ' ' . htmlspecialchars($appointment['lastname']); ?></h6>
                                <p class="mb-1">Age: <?= htmlspecialchars($appointment['age']); ?></p>
