...
$title = 'Completed Immunization Appointments';
...
$appointments = getCompletedImmunizationAppointmentsByResident($conn, $resident_id);
        ...
        <div class="container mt-4 px-5">
            ...
            <div class="row mb-3 shadow p-4 gy-2">
                <div class="col-md-6">
                    ...
                    <a href="completed_immunization_appointments.php" class="btn btn-success btn-sm">Completed</a>
