...
$consultations = getConsultationsBySchedule($consultation_schedule_id, $conn);
...
<body class="poppins-regular">
    ...
    <div class="flex-grow-1 bg-slate-100">
        ...
        <div class="container mt-4 px-5">
                ...
                <div class="col-md-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Consultation List</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <a href="consultation_details.php?con_sched_id=<?= $consultation_schedule_id ?>" class="btn btn-primary btn-sm">Consultations</a>
            ...
            <div class="row mb-4">
                <div class="col-md-12 shadow p-5">
                    <table id="consultationsTable" class="table display text-sm table-info">
                        <thead>
                            <tr>
